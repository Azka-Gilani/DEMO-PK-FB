...
def processRequest(req):
    ...
    baseurl = "https://aarz.pk/search/bot?postedBy=searchPage&view=&city_s="+city_names+"&loc1="+sector_name+"&price_min="+maximum_value+"&price_max=0&land_area="+unit_property+"&min_r=0&max_r="+area_property+"&estate_agent=&hot="+latest+"&purpose=Sell&property_type="+property_type+"&school="+school+"&airport="+airport+"&transport="+transport+"&security="+security+"&shopping_mall="+malls+"&fuel="+fuel
